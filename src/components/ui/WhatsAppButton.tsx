...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      rel="noreferrer"
      href={href}
      whileHover={{ y: -6, boxShadow: '0 30px 60px rgba(16,185,129,0.12)' }}
      whileTap={{ scale: 0.98 }}
      className="fixed right-6 bottom-6 z-50 inline-flex items-center gap-3 rounded-full px-4 py-3 text-white shadow-2xl btn-3d"
    >
