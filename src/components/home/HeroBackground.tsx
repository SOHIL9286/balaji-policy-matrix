...
export function HeroBackground() {
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 overflow-hidden">
      ...
      />
      <div
        className="hero-orb absolute right-0 top-10 h-[26rem] w-[26rem] rounded-full bg-brand-accent/20 blur-[120px]"
        style={{
      ...
      />
      <div className="absolute inset-x-[10%] top-[12%] h-40 rounded-full border border-white/10 bg-white/5 blur-3xl" />
