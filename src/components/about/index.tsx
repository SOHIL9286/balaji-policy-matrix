...
function Hero() {
  return (
    <section className="hero-gradient-bg py-24 text-white">
      <div className="container mx-auto px-6">
        <motion.div initial="hidden" animate="show" variants={sectionFade} className="glass-panel p-10 rounded-3xl max-w-5xl mx-auto">
  ...
  return (
    <section className="py-20">
      <div className="container mx-auto px-6 grid gap-8 md:grid-cols-2 items-start">
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={sectionFade} className="glass-panel p-8 rounded-2xl">
    ...
    <section className="py-12">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 md:grid-cols-3">
          {values.map((v) => (
            <motion.div key={v} whileHover={{ scale: 1.03 }} className="glass-panel p-6 rounded-xl">
...
function WhyTrust() {
  return (
    <section className="py-12 bg-gradient-to-b from-white/5 to-transparent">
      <div className="container mx-auto px-6 grid gap-8 md:grid-cols-2 items-center">
        ...
        <motion.div className="glass-panel p-8 rounded-xl" initial={{ scale: 0.98, opacity: 0.8 }} whileInView={{ scale: 1, opacity: 1 }} viewport={{ once: true }}>
    ...
    <section className="py-12">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-6 space-y-6">
          {events.map((e) => (
            <motion.div key={e.year} className="flex items-start gap-6" initial="hidden" whileInView="show" viewport={{ once: true }} variants={sectionFade}>
...
function Achievements() {
  ...
  return (
    <section className="py-12 bg-gradient-to-b from-transparent to-white/2">
      <div className="container mx-auto px-6">
    ...
    <section className="py-12">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-2 md:grid-cols-3">
          {members.map((m) => (
            <motion.div key={m.name} className="glass-panel p-6 rounded-xl text-center" whileHover={{ translateY: -6 }}>
...
function Stats() {
  ...
  return (
    <section className="py-12 bg-gradient-to-r from-white/3 to-transparent">
      <div className="container mx-auto px-6 flex gap-6 justify-center">
        {stats.map((s) => (
          <div key={s.label} className="glass-panel p-6 rounded-xl text-center">
